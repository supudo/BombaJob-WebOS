enyo.kind({
  ...
  components: [
      {kind : "PageHeader", components : [
          { name : "headerText", kind : enyo.VFlexBox, content : "People", flex : 1 },
  ...
  create: function() {
      ...
      var that = this;
      JobOffer.all().filter('humanyn', '=', 'true').filter('cid', ((this.CategoryID > 0) ? '=' : '>'), ((this.CategoryID > 0) ? this.CategoryID : '0')).order("publishdate", false).list(null, function (results) {
